...
export const AlarmProcessStatus = [
    CodeMap.from('未知状态', -1),
    CodeMap.from('待确认', 0),
    CodeMap.from('确认误报', 1),
    CodeMap.from('确认报警', 2),
...
export const InterfaceCategory = [
